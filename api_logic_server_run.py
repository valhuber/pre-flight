...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 10.00.15, January 02, 2024 19:21:11):
...
app_logger.info(f'Created January 02, 2024 19:21:11 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 10.00.15\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 10.00.15\n'
    msg += f'.. startup message: {start_up_message}\n'
