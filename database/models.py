...
#
# Created:  January 02, 2024 19:21:11
...
from database.ALSBase import AlsBase
...
class CustomerDemographic(AlsBase, Base):
...
class SampleDBVersion(AlsBase, Base):
...
class EmployeeAudit(AlsBase, Base):
...
class EmployeeTerritory(AlsBase, Base):
...
class OrderDetail(AlsBase, Base):
